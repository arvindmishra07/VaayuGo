...
android {
    namespace  = "com.vaayugo.app"
    compileSdk = 35

    defaultConfig {
        applicationId   = "com.vaayugo.app"
        minSdk          = 26
        targetSdk       = 35
        versionCode     = 1
        versionName     = "1.0.0"
    ...
    buildTypes {
        ...
        release {
            ...
            buildConfigField("String", "BASE_URL", "\"https://api.vaayugo.dev/api/\"")
        }
    }
...
dependencies {
    ...
    implementation(project(":feature:shopkeeper"))
